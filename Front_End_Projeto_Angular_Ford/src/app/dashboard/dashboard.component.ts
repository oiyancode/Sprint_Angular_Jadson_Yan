...
export class DashboardComponent implements OnInit {
  ...
  loadVehicles() {
    ...
    this.vehicleService.getVehicles().subscribe({
      next: (vehicles: Veiculo[]) => {
        ...
        // Se não há veículos, mostrar indicador de API offline
      ...
      error: (error) => {
        ...
        this.errorMessage = 'Sem conexão com a API. Não é possível carregar dados dos veículos.';
        this.isLoadingVehicles = false;
        this.isApiOffline = true;
      },
    });
  ...
  loadVehicleData() {
    ...
    this.vehicleService.getVehicleData().subscribe({
      next: (response: { vehicleData: VehicleData[], pagination: any }) => {
        this.vehicleData = response.vehicleData;
        this.filteredVehicleData = response.vehicleData;
        this.isLoadingVehicleData = false;
        
        // Se não há dados, mostrar indicador de API offline (sem errorMessage)
